...
- 总体数据分析
  ...
  - 主要数据分布
    ...
    - 配送天差分布
      ...
      ![img](../../Derry%20Lin/Desktop/img/img.png)

    - 签收小时分布

      ![img](../../Derry%20Lin/Desktop/img/img3.png)

- 训练集数据分析

  - 配送天数分布

    ![img](../../Derry%20Lin/Desktop/img/img2.png)

  - 签收小时分布

    ![img](../../Derry%20Lin/Desktop/img/img5.png)

- 验证测试集分析

  - 配送天数分布

    ![img](../../Derry%20Lin/Desktop/img/img7.png)

  - 签收小时分布

    ![img](../../Derry%20Lin/Desktop/img/img6.png)
